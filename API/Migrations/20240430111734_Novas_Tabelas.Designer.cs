...
namespace FluxoCaixa.Migrations
{
    ...
    [Migration("20240430111734_Novas_Tabelas")]
            ...
            modelBuilder.Entity("FluxoCaixa.Models.Registro", b =>
                {
                    ...
                    b.HasKey("IdRegistro", "IdCategoria", "IdSubcategoria", "IdCusto", "IdFluxo", "IdFormaDePagamento");
                    ...
                    b.HasIndex("IdCategoria", "IdSubcategoria");
            ...
            modelBuilder.Entity("FluxoCaixa.Models.Registro", b =>
                {
                    ...
                    b.HasOne("WebApplication1.Models.Subcategoria", "Subcategoria")
                        .WithMany("Registros")
                        .HasForeignKey("IdCategoria", "IdSubcategoria")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
